# Tushar Gaikwad (www.github/devSython)
# Pyqt5 project : Rock Paper Scissor Game..
...
class Window(QMainWindow):
    ...
    def UiComponents(self):
        ...
        self.choice = 0
        # creating head label
        head = QLabel("DevSython\n[Rock-Paper-Scissor]", self)
    ...
    def com_action(self):
        ...
        if self.comp_choice == 1:
            ...
            self.computer.setStyleSheet("border-image : url(rock.jpg);")
        elif self.comp_choice == 2:
            # setting paper image to the computer label
            self.computer.setStyleSheet("border-image : url(paper.jpg);")
        else:
            # setting scissor image to the computer label
            self.computer.setStyleSheet("border-image : url(siccor.jpg);")
    ...
    def rock_action(self):
        ...
        self.user.setStyleSheet("border-image : url(rock.jpg);")
        self.user.setText("")
    ...
    def paper_action(self):
        ...
        # setting rock image to the user label
        self.user.setText("")
        self.user.setStyleSheet("border-image : url(paper.jpg);")
        # disabling the push button
        self.rock.setDisabled(True)
        self.paper.setDisabled(True)
        self.scissor.setDisabled(True)
    ...
    def scissor_action(self):
        ...
        # setting rock image to the user label
        self.user.setText("")
        self.user.setStyleSheet("border-image : url(siccor.jpg);")
        # disabling the push button
        self.rock.setDisabled(True)
        self.paper.setDisabled(True)
        self.scissor.setDisabled(True)
